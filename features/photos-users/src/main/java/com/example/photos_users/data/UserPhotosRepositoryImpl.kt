...
class UserPhotosRepositoryImpl @Inject constructor(private val api: PhotosApi) :
    UserPhotosRepository {
    override suspend fun getUserPhotos(username: String?, page: Int): List<Photo> {
        return api.getUserPhotos(username?:"", page)
    }
}
